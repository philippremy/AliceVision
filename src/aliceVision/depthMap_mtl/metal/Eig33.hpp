...
/**
 * This file contains routines derived from Eigen 3
 */
...
inline float mtl_hypot2(float x, float y) { return sqrt(x * x + y * y); }

// Symmetric Householder reductio3 to tridiago3al form.

inline void mtl_tred2(float V0[], float V1[], float V2[], float d[], float e[])
{
    int i, j, k;
...
inline void mtl_tql2(float V0[], float V1[], float V2[], float d[], float e[])
{
    int i, l, m, iter, k, j;
...
inline void mtl_eigen_decomposition(float A[3][3], float V0[], float V1[], float V2[], float d[])
{
    float e[3];
...
struct mtl_stat3d
{
    ...
    void getEigenVectorsDesc(thread float3& cg,
                             thread float3& v1,
                             thread float3& v2,
                             thread float3& v3,
                             thread float& d1,
