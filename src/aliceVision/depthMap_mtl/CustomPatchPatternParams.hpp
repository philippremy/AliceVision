...
/**
 * This file contains options for defining a custom patch pattern to be used
 * in Depth Map computation
 */
...
std::istream& operator>>(std::istream& is, aliceVision::depthMap::mtl::CustomPatchPatternParams::SubpartParams& sp);

// to ostream
// note: useful for command-line
std::ostream& operator<<(std::ostream& os, const aliceVision::depthMap::mtl::CustomPatchPatternParams::SubpartParams& sp);
